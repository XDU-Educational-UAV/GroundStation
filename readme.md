...
|-     |-   |-     |-   |-    |-   |- |
|状态  |3E  |01    |02  |u8×2 |SUM |飞机状态(BIT7侧翻,BIT0解锁)/电压(2分后乘100取整)|
...
|帧名称|帧头|功能字|长度|数据 |校验|备注|
|-     |-   |-     |-   |-    |-   |-|
|解锁  |3C  |01    |02  |u8×2 |SUM |解锁(BIT2陀螺仪校准,BIT1加速度计校准,BIT0解锁),控制密码|
|遥控  |3C  |08    |08  |s16×4|SUM |roll/pitch/throttle/yaw控制数据|
